...
- **Email:** security@react-gtm-kit.dev (monitored Monday–Friday, 9:00–17:00 PT).
...
- Active support covers the main branch and the most recent minor release for each `@react-gtm-kit/*` package.
